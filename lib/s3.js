...
S3.src = function src(path, options) {
	options = Object.assign({ format: 'query' }, options);
...
S3.prototype.src = function wrapSrc(path, options) {
	return S3.src(path, Object.assign({ }, this.options, options));
};

S3.prototype.dest = function wrapDest(path, options) {
	return S3.dest(path, Object.assign({ }, this.options, options));
};
